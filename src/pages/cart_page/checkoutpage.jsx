          ...
          <div className="billOrderDiv" id="billDiv">
            ...
            <form className="billForm">
              <div className="billLabelInputDiv">
                ...
                <input type="text" value={""} required className="billInput" />
              </div>
              <div className="billLabelInputDiv">
              ...
              <div className="billLabelInputDiv">
                ...
                <input type="text" value={"Nigeria"} readOnly className="billInput" />
              </div>
              <div className="billLabelInputDiv">
                <label className="billLabel">Street address *</label>
                <input type="text" value={"House number and street address"} required className="billInput" />
              </div>
              <div className="billLabelInputDiv">
                <input type="text" value={"Apartment, suite, unit, etc. (optional)"} className="billInput" />
              </div>
              <div className="billLabelInputDiv">
              ...
              <div className="billLabelInputDiv">
                ...
                <input type="tel" value={""} required className="billInput" />
              </div>
              <div className="billLabelInputDiv">
                <label className="billLabel">Email *</label>
                <input type="email" value={""} required className="billInput" />
              </div>
            </form>
            ...
            <div id="billOptTextDiv">
              ...
              <textarea name="" id="billOptTextArea" value={"Notes about your order"}></textarea>
            </div>
          </div>
